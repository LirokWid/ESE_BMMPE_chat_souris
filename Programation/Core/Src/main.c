...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pins : LIDAR_MOTOR_ENABLE_Pin LIDAR_MESURE_ENABLE_Pin */
  ...
  /*Configure GPIO pins : LED_STATE_Pin LED_ERROR_Pin */
  ...
  /*Configure GPIO pins : BORDURE_1_Pin BORDURE_2_Pin BORDURE_3_Pin */
  GPIO_InitStruct.Pin = BORDURE_1_Pin|BORDURE_2_Pin|BORDURE_3_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);

  /*Configure GPIO pins : BUMPER_1_Pin BUMPER_2_Pin */
  GPIO_InitStruct.Pin = BUMPER_1_Pin|BUMPER_2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);

  /*Configure GPIO pins : BUMPER_3_Pin BUMPER_4_Pin */
