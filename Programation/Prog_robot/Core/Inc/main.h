...
/* Private defines -----------------------------------------------------------*/
#define LIDAR_PWM_Pin GPIO_PIN_12
...
#define BORDURE_1_Pin GPIO_PIN_13
#define BORDURE_1_GPIO_Port GPIOB
#define BORDURE_1_EXTI_IRQn EXTI4_15_IRQn
#define BORDURE_2_Pin GPIO_PIN_14
#define BORDURE_2_GPIO_Port GPIOB
...
#define BUMPER_1_Pin GPIO_PIN_6
#define BUMPER_1_GPIO_Port GPIOC
#define BUMPER_1_EXTI_IRQn EXTI4_15_IRQn
#define BUMPER_2_Pin GPIO_PIN_7
#define BUMPER_2_GPIO_Port GPIOC
#define BUMPER_2_EXTI_IRQn EXTI4_15_IRQn
#define BUMPER_3_Pin GPIO_PIN_8
#define BUMPER_3_GPIO_Port GPIOD
#define BUMPER_3_EXTI_IRQn EXTI4_15_IRQn
#define BUMPER_4_Pin GPIO_PIN_9
#define BUMPER_4_GPIO_Port GPIOD
